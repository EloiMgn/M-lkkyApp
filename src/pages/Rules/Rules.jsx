  ...
  return (
    <div id="Rules" className="Rules">
      ...
      <main className='Rules__content'>
        ...
        <h3>Mise en place</h3>
        <ul>
          <li>Les quilles numérotées sont placées dans une <strong>formation</strong> (voir <a href='./Skittles'>page de placement des quilles</a>)</li>
        ...
        <ul>
          ...
          <li>Après chaque lancer, les quilles sont relevées <strong>à l'endroit où elles se sont immobilisées</strong></li>
